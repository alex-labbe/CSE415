        ...
        while OPEN != []:
            ...
            for op in self.Problem.OPERATORS:
                if op.is_applicable(S):
                    ...
                    # 4 - Generate the list L of successors of S and
                    # delete those from L those states already appearing on closed
                     # 5 - Delete from L any members of the Open that occur on L
