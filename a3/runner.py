...
if __name__ == '__main__':
    ...
    import minimax_agent_s

    #s = game.GameState.empty((3, 4), 3)
    s = game.GameState.no_corners()
    # s = game.GameState.no_corners_small()
    # s = game.GameState.tic_tac_toe()
    a1 = agent.Agent(s, game.O_PIECE)
    a2 = minimax_agent.MinimaxAgent(s, game.O_PIECE)
    a3 = minimax_agent_s.MinimaxAgent(s, game.X_PIECE)
    r = GameRunner(x_agent=a2, o_agent=a3)

    r.run_game(s, time_limit=None, silent=False, transcript_name="cmordi")
